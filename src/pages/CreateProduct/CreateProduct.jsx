...
import { createPost, getAllBrands } from '../../redux/actions'; //, getAllProducts
...
//   // if (!input.spec) errors.spec = "Spec necessary"
//   return errors;
// }
...
const CreateProduct = () => {
  ...
  // console.log(allBrandData, 'data de front')
  // const allSpec = useSelector((state) => state.copyProducts);
  // console.log(allSpec,'soy lo que llega al front')
  ...
  const handleChange = (e) => {
    ...
    console.log(name, 'soy el name del form')
    console.log(value, "soy el value del form")
    setInput({
      ...input,
      [name]: value,
    });
      ...
      <div className="abs-center">
        <form onSubmit={(e) => handleSubmit(e)} className="border row g-3 needs-validation p-3 form border-info">
          ...
          <div className="form-group m-2">
            ...
            <input type="text" onChange={(e) => handleChange(e)} name="spec" className="form-control" value={input.spec}></input>
          </div>
